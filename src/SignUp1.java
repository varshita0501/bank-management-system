...
public class SignUp1 extends JFrame implements ActionListener {
    ...
    SignUp1(){
        ...
        add(female);
        // to handle the selection of only one item we create one group which contains both mail and female
        ...
        // to handle the selection of only one item we create one group which contains both married and unmarried
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        String name = nameTextField.getText(); // setText and getText
